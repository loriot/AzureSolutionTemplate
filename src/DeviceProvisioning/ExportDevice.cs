...
namespace DeviceProvisioning
{
    public static class ExportDevice
    {
        ...
        public static async Task Run([ServiceBusTrigger("%DEVICE_LIFECYCLE_QUEUE_NAME%", AccessRights.Manage, Connection = "AzureWebJobsConnection")]BrokeredMessage message, TraceWriter log)
        {           
